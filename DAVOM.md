...
**Oxirgi yangilanish:** v174.2 · 2026-08-13
...
| | |
|---|---|
| Versiya | **v174.2** (`index.html` birinchi qatorida `<!-- v174.2 -->`, `APP_VER` da ham) |
...
| Git | **v174.2 gacha push qilingan** (2026-08-13) — prod v174.2. |

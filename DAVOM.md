...
**Oxirgi yangilanish:** v175.2 · 2026-08-16
...
| | |
|---|---|
| Versiya | **v175.2** (`index.html` birinchi qatorida `<!-- v175.2 -->`, `APP_VER` da ham) |
...
| Git | **v175.2 gacha push qilingan** — prod v175.2. ✅ Ibrohim prodda tasdiqladi (2026-08-16). |

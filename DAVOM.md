...
**Oxirgi yangilanish:** v175.4 · 2026-08-16
...
| | |
|---|---|
| Versiya | **v175.4** (`index.html` birinchi qatorida `<!-- v175.4 -->`, `APP_VER` da ham) |
...
| Git | **v175.4 gacha push qilingan** — prod v175.4. ⏳ Ibrohim tekshiradi (v175.3 PDF + v175.4 hisobot). |

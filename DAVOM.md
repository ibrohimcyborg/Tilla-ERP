...
**Oxirgi yangilanish:** v172.18 · 2026-08-06
...
| | |
|---|---|
| Versiya | **v172.18** (`index.html` birinchi qatorida `<!-- v172.18 -->`, `APP_VER` da ham) |
...
| Git | **v172.18 gacha push qilingan** (2026-08-06, Ibrohim buyrug'i bilan) — prod v172.18. Keyingi push qarori faqat Ibrohimda. |

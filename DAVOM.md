...
**Oxirgi yangilanish:** v172.21 · 2026-08-06
...
| | |
|---|---|
| Versiya | **v172.21** (`index.html` birinchi qatorida `<!-- v172.21 -->`, `APP_VER` da ham) |
...
| Git | **v172.21 gacha push qilingan** (2026-08-06, Ibrohim buyrug'i bilan) — prod v172.21. Keyingi push qarori faqat Ibrohimda. |
